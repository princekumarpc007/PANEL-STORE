...
/* ==========================================================================
   PAGE-SPECIFIC ENGINE: PROFILE.JS
   ========================================================================== */
console.log("[CORE] Building Profile Jamin...");
...
const initProfileEngine = () => {
    ...
    document.querySelectorAll(".premium-stat-card").forEach((e, t) => {
        ...
        auth.currentUser ? window.location.href = './hwid-reset.html' : window.location.href = './login.html?tab=login'
    })
};
if (document.readyState === "loading") document.addEventListener("DOMContentLoaded", initProfileEngine); else initProfileEngine();
